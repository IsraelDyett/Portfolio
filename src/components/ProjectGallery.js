...
import bms from "./content/budget.png"
import wp from "./content/welcomemassy.png"
...
import onmarkttCatbot from "./content/OnmarkTTChatbot.png"
import salesCommission from "./content/SalesCommissins.png"
...
const ProjectGallery = () => {
  ...
  const projects = [
    ...
    {
      title: "AI-Powered Facebook Messenger Chatbot with Dialogflow and OpenAI Integration",
      description: "Developed an AI-driven chatbot that integrates Facebook Messenger with Dialogflow and OpenAI to provide automated, intelligent responses to customer inquiries. The system retrieves customer messages from Facebook Messenger and passes them to Dialogflow for intent detection. Using Firebase, it pulls past conversation data for contextual understanding, which is then leveraged by OpenAI to generate accurate, context-aware responses. These responses are sent back to the customer and stored in Firebase for future interactions. The entire system is connected via APIs, and the webhook endpoints are hosted on Google Cloud using Node.js, ensuring scalable and secure communication between platforms.",
      url: "https://github.com/IsraelDyett/OnMarkTT-Chatbot",
      link: "https://github.com/IsraelDyett/OnMarkTT-Chatbot",
      image: onmarkttCatbot
    },
    {
      title: "Full-Stack Web Application for Bulk Data Management",
      description: "Developed a full-stack web application that enables seamless CRUD operations, along with bulk editing, deletion, and CSV upload capabilities. The frontend was built using SvelteKit and Tailwind CSS, ensuring a responsive and dynamic user interface. Integrated a .NET C# ASP API on the backend with Windows Authentication to ensure secure access. The system efficiently handles large datasets, supporting bulk data management for improved operational productivity.",
      url: "https://github.com/IsraelDyett/SalesCommissionAPI-Massy",
      link: "https://github.com/IsraelDyett/SalesCommision_Interface_client-Massy",
      image: salesCommission
    },
    {
    ...
    },
    {
      ...
      url: "https://github.com/IsraelDyett/BudgetManager-Massy",
